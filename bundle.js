    ...
    */
    ...
    value: function callApi(path, httpMethod, pathParams, queryParams, headerParams, formParams, bodyParam, authNames, contentTypes, accepts, returnType) {
      ...
      if (typeof headerParams['User-Agent'] === 'undefined') {
        headerParams['User-Agent'] = 'autodeskforgedesignautomation-js-sdk' + '/3.0.0' + ' (Forge RSDK)';
      } else {
        var userAgent = headerParams['User-Agent'];
        userAgent = userAgent.concat(' autodeskforgedesignautomation-js-sdk').concat('/3.0.0').concat(' (Forge RSDK)');
...
function () {
   ...
   * @class
   * @param productVersion {String} The product version of the Engine (the version of the binary that will be uploaded).
   */
  function Engine(productVersion) {
  ...
  _createClass$b(Engine, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new Engine();
        if (data.hasOwnProperty('package')) obj["package"] = AutodeskForgeDesignAutomationClient.convertToType(data['package'], 'String');
        if (data.hasOwnProperty('productVersion')) obj.productVersion = AutodeskForgeDesignAutomationClient.convertToType(data['productVersion'], 'String');
        if (data.hasOwnProperty('description')) obj.description = AutodeskForgeDesignAutomationClient.convertToType(data['description'], 'String');
        if (data.hasOwnProperty('version')) obj.version = AutodeskForgeDesignAutomationClient.convertToType(data['version'], 'Number');
        if (data.hasOwnProperty('id')) obj.id = AutodeskForgeDesignAutomationClient.convertToType(data['id'], 'String');
      }
...
Engine.prototype.version = undefined;
/**
 * @member {String} id
 */
...
function () {
  ...
  */
  ...
  _createClass$x(AutodeskForgeDesignAutomationApi, [{
    ...
    key: "geActivityVersionWithHttpInfo",
    value: function geActivityVersionWithHttpInfo(id, version, customHeader) {
      customHeader = customHeader || {};
      var postBody = null; // verify the required parameter 'id' is set

      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling geActivityVersion");
      } // verify the required parameter 'version' is set


      if (version === undefined || version === null) {
        throw new Error("Missing the required parameter 'version' when calling geActivityVersion");
      }
    ...
    key: "geActivityVersion",
    value: function geActivityVersion(id, version, customHeader) {
      return this.geActivityVersionWithHttpInfo(id, version, customHeader).then(function (response_and_data) {
        return response_and_data.data;
      });
    }
    /**
